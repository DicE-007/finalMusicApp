...
class AlbumLayout2 extends StatefulWidget {
  static const path = "/albumlayout2";
  final AlbumElement albumInstance;
  AlbumLayout2(this.albumInstance);

  @override
  State<AlbumLayout2> createState() => _AlbumLayout2State();
}

class _AlbumLayout2State extends State<AlbumLayout2> {
  List<TrackElement> albumSongs = [];
  ScrollController _scrollController = ScrollController();
  double imageSize = 0;
  double initSize = 240;
  double containerheight = 515;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(widget.albumInstance.name??""),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Stack(
                ...
                children: [
                  ...
                  Opacity(
                    ...
                    child: Container(
                      ...
                      child: Image(
                        image: NetworkImage(widget.albumInstance.imageUrl ?? ""),
                        width: imageSize,
                        height: imageSize,
                        fit: BoxFit.cover,
                      ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  Text(
                                    "TrackCount: ${widget.albumInstance.trackCount}",
                                    style: TextStyle(
                            ...
                            onTap: () {
                              ...
                              onLongPress: () async {
                                ...
                                if (isExist) {
                                  ...
                                  creatTrackInstanceForFirebase(albumSongs[idx]);
                                  final scaffold = ScaffoldMessenger.of(context);
